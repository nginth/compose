...
class ConversionMap(object):
    map = {
        service_path('blkio_config', 'weight'): int,
        service_path('blkio_config', 'weight_device', 'weight'): int,
        service_path('cpus'): float,
        service_path('cpu_count'): int,
        service_path('configs', 'mode'): int,
        service_path('secrets', 'mode'): int,
        service_path('healthcheck', 'retries'): int,
        service_path('healthcheck', 'disable'): to_boolean,
        service_path('deploy', 'replicas'): int,
        service_path('deploy', 'update_config', 'parallelism'): int,
        service_path('deploy', 'update_config', 'max_failure_ratio'): float,
        service_path('deploy', 'restart_policy', 'max_attempts'): int,
        service_path('mem_swappiness'): int,
        service_path('oom_score_adj'): int,
        service_path('ports', 'target'): int,
        service_path('ports', 'published'): int,
        service_path('scale'): int,
        service_path('ulimits', PATH_JOKER): int,
        service_path('ulimits', PATH_JOKER, 'soft'): int,
        service_path('ulimits', PATH_JOKER, 'hard'): int,
        ...
        re_path_basic('secrets', 'external'): to_boolean,
        re_path_basic('configs', 'external'): to_boolean,
    }
